...
let tipotarjeta= document.querySelector('.input-tipo');
let numerotarjeta= document.querySelector('.input-numero');
let cargo= document.querySelector('.input-cargo');
let valorFacturas= document.querySelector('.input-facturas');
...
$(".btn-editu").click(function (e) { 
    ...
    //alert(`User info: ${email.value} ${documento.value} ${nombre.value} ${apellidos.value} ${tipotarjeta.value} ${numerotarjeta.value} ${cargo.value} ${valorFacturas.value}`);
    fetch('/usuarios', {
        method: 'put',
        ...
        body: JSON.stringify({
            ...
            tipotarjeta: `${tipotarjeta.value}`,
            numerotarjeta: `${numerotarjeta.value}`,
            cargo: `${cargo.value}`,
            valorFacturas:`${valorFacturas.value}`,
